...
void main_ZZDiBosonAnalysis(int proof = 0, int option= 1)
{
  ...
  chain_ggH125_ZZ4lep->Process("ZZDiBosonAnalysis.C+","ggH125_ZZ4lep");
  ...
  chain_ZH125_ZZ4lep->Process("ZZDiBosonAnalysis.C+","ZH125_ZZ4lep");
  ...
  chain_WH125_ZZ4lep->Process("ZZDiBosonAnalysis.C+","WH125_ZZ4lep");
  ...
  chain_VBF125_ZZ4lep->Process("ZZDiBosonAnalysis.C+","VBFH125_ZZ4lep");

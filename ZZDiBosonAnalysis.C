...
void ZZDiBosonAnalysis::Terminate()
{
    ...
    std::cout << "Eventos:" << nEvents << std::endl;
    std::cout << "Primer corte:" << cut1 << std::endl;
    std::cout << "Quinto corte:" << cut5 << std::endl;
    std::cout << "Sexto corte:" << cut6 << std::endl;
    std::cout << "Séptimo corte:" << cut7 << std::endl;
    std::cout << "Octavo corte:" << cut8 << std::endl;
    std::cout << "Entradas:" << fChain->GetTree()->GetEntries() << std::endl;
